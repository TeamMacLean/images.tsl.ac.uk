      ...
      .then((groups) => {
        ...
        groups = groups.map((g) => {
          ...
          if (
            !!Util &&
            !!Util.canAccessGroup &&
            !Util.canAccessGroup(result.safeName, req)
          ) {
          ...
          if (result.safeName && result.safeName === "jep23kod") {
            console.log("reset image for jep23kod group");

            result.image = "/img/groups/jep23kod.jpg";
          }
