...
module.exports = {
    ...
    canAccessGroup: function (groupSafeName, req) {
        ...
        if (!req.user){
            ...
            console.log('no errors in initial info');            
        }
        ...
        console.log('for user: ' + req.user.username, '\nlooking at users LDAP groups:\n', req.user.memberOf, '\n...to see any of the following strings are in them:\n', match.groupsWithAccess, '\n...in order to determine if match and thus enabled!');
        ...
        const result = userIsAdmin || inGroup; 
        console.log('userIsAdmin', userIsAdmin, 'inGroup', inGroup, 'thus returning: ' + result)
